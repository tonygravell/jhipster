...
import test.config.SecurityConfiguration;
import test.config.SecurityJwtConfiguration;
import test.config.WebConfigurer;
import test.management.SecurityMetersService;
import test.web.rest.AuthenticateController;
